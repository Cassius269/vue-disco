<script setup>
import { ref } from "vue"; // importation de la méthode ref() pour la création de variables
...
// Ajout de la fonctionnalité d'ajout/retrait de nobres d'albums
const stockPlus = (album) => {
  album.stock++;
};

const stockMoins = (album) => {
  if (album.stock > 0) {
    album.stock--;
  }
};
...
<template>
  <div class="min-h-screen flex flex-col">
    <header
      class="h-32 text-2xl w-full flex-none -ml-full shadow-lg bg-gradient-to-br from-teal-600 to-cyan-400"
    >
      <div
                ...
                <div class="mt-4 space-y-4">
                  <div class="flex items-start">
                    ...
                    <div class="ml-3 text-sm">
                      <label for="comments" class="font-medium text-cyan-700"
                        >In stock only</label
                      >
                    </div>
                  </div>
            ...
            >
              ...
              <div class="flex-grow sm:text-left text-center mt-6 sm:mt-0">
                ...
                <h3 class="text-black text-xl title-font mb-2">
                  {{ album.artist }}
                  <span class="font-light mr-2">{{ album.year }}</span>
                </h3>
                ...
                <div class="py-4">
                  <div class="inline-block mr-2">
                    ...
                    <div
                      v-if="album.stock > 0"
                      class="flex pr-2 h-full items-center"
                    >
                      <svg
